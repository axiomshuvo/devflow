        ...
        <div className="flex items-center gap-2.5 mb-10">
          <div className="w-9 h-9 bg-blue-500 rounded-lg flex items-center justify-center">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              ...
              <path d="M13 13 L17 13 M15 11 L15 15" stroke="white" strokeWidth="2" strokeLinecap="round" />
            </svg>
          </div>
        ...
        <div className="mt-auto">
          <div className="bg-[#1e2d5a] rounded-xl p-4 shadow-2xl border border-white/10">
                ...
                <div className="space-y-1.5">
                  {[60, 85, 40, 70].map((w, i) => (
                    <div key={i} className="flex items-center gap-2">
                      <div className={`w-1.5 h-1.5 rounded-full ${["bg-blue-400", "bg-green-400", "bg-amber-400", "bg-purple-400"][i]}`} />
                      <div className="h-1.5 bg-slate-600 rounded-full flex-1" style={{ maxWidth: `${w}%` }} />
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-[#253166] rounded-lg p-3 flex flex-col items-center justify-center">
                ...
                <div className="relative w-12 h-12">
                  <svg viewBox="0 0 36 36" className="w-12 h-12 -rotate-90">
                    <circle cx="18" cy="18" r="14" fill="none" stroke="#2d3d7a" strokeWidth="4" />
                    <circle
                  ...
                  <span className="absolute inset-0 flex items-center justify-center text-white text-[10px] font-bold rotate-90">75%</span>
                </div>
              </div>
            </div>
            {/* Team activity + chart */}
            <div className="bg-white rounded-lg p-3 grid grid-cols-2 gap-2">
              <div>
                <p className="text-gray-500 text-[8px] font-semibold mb-2">Team Activity</p>
                {[1, 2, 3].map((i) => (
              ...
              <div>
                ...
                <p className="text-green-500 text-[8px] font-semibold">On Track +24%</p>
              </div>
            </div>
          </div>
        </div>
