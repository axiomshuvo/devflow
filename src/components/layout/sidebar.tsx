...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "flex flex-col h-screen bg-[#0f172a] border-r border-white/10 transition-[width] duration-300 shrink-0 overflow-hidden",
        collapsed ? "w-16" : "w-60",
      )}
    >
      {/* Logo */}
      ...
      <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
        {/* Nav */}
        <nav className={cn("space-y-0.5 py-4", collapsed ? "px-1" : "px-2")}>
        ...
        {!collapsed && pathname === "/my-tasks" && (
          <div className="mx-2 mb-4 p-3 rounded-xl bg-white/5 border border-white/10 min-w-0">
              ...
              <div className="flex flex-col gap-2">
                {[
                  ...
                  <div key={title} className="flex items-start gap-2">
                    <span
                      className={`w-2 h-2 rounded-full ${dot} mt-1 shrink-0`}
                    />
                    <div>
        ...
        {/* Workspace Progress */}
        {!collapsed && (
          <div className="mx-2 mb-4 min-w-0">
